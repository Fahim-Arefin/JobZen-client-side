...
function Button({ children, primary, secondary, outline, ...rest }) {
  let primaryStyle = `rounded-lg border-none bg-[#aea1ea] font-semibold  tracking-wide
  ...
  let primaryOutline = `rounded-lg border border-[#aea1ea] font-semibold  tracking-wide
